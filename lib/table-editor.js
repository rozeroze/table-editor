...
const TableEditor = option => {
   ...
   // prepare
   {
      te.set('editable', (option.editable || false));
      te.set('top-as-header', (option.top_as_header || false));
      let entity;
      if (option.entity != undefined) {
         entity = option.entity;
      } else {
         entity = te.get_itable();
      }
      // entity
      te.set('entity', JSON.stringify(entity));
      te.set_entity_frame();
      // itable
      te.structuring(entity);
      te.set_itable_frame();
